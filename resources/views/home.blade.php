            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="filter__controls">
                        <li class="active" data-filter="all">Top Products</li>
                    </ul>
                </div>
            </div>
            <div class="row product__filter">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix tshirts">
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{$product['photo']}}">
                        ...
                        <div class="product__item__text">
                            ...
                            @else
                                <a href="{{url('show_product')}}/{{$product['id']}}" class="add-cart">+ Show product details</a>
                            @endif
                ...
                <a href="/shop" class="primary-btn">More Products <span class="arrow_right"></span></a>
